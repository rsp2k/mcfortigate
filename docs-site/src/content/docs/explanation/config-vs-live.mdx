...
So it reports a three-valued `verdict`, names every source it could not read,
and omits `safe_to_delete` entirely rather than claiming a conclusion it cannot
support. [The full shape](/reference/tools/#find_references).
